...
$$\hat{Y}_{ti} = [\gamma_{00} +   U_{0i}] + [\gamma_{10}   ]  * Time_{ti}$$ Slope is fixed across people, intercept can be the average effect or a person specific one. Then time varies.
...
.pull-left\[ $$\text{Total variance CS} = \begin{pmatrix} 
